...
module.exports = async function (command) 
{
        ...
        switch(args[0])
    {
        ...
        case 'all':
            ...
            "\nGame 5: played on "  + gameDates[4] + " against " + gameNames[4]+ ", score was: "+   gameScores[4] + 
            "\nGame 6: played on " + gameDates[5] + " against "  + gameNames[5] + ", score was: " + gameScores[5] + 
            "\nGame 7: played on " + gameDates[6] + " against "  + gameNames[6] + ", score was: " + gameScores[6] + 
            "\nGame 8: played on " + gameDates[7] + " against "  + gameNames[7] + ", score was: " + gameScores[7] + 
            "\nGame 9: played on " + gameDates[8] + " against "  + gameNames[8] + ", score was: " + gameScores[8] + 
